# 1 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c"
...
# 1 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2
...
# 2 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"fbf49cfdda434344bbb50781fdacdc4a\",\"statu"
...
char *random_vehicle_type;
char *random_gender;
char *random_driving_record;
int random_age;
int car_car_model;
int car_name_count;
char *selectedCarModel;
char *gender;
char *selectedCar = 0;
char *random_financial_type;
int randomYear;
int think_time = 10;

# 3 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2
...
# 4 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2
...
TC_01_lanuch()
{
	...
	lr_end_transaction("TC_01_lanuch", 2);

	return 0;
}
# 5 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2
...
TC_02_login()
{
	...
	lr_think_time(think_time);
	lr_end_transaction("TC_02_login", 2);
	return 0;
}
# 6 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2

# 1 "TC_03_select_automobile_type.c" 1
TC_03_select_automobile_type()
{
	...
	web_submit_data("quote_auto.jsf_2",
	 ...
	 lr_think_time(think_time);
	 lr_end_transaction("TC_03_select_automobile_type", 2);
	return 0;
}
# 7 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2

# 1 "TC_04_select_the_option.c" 1
TC_04_select_the_option()
{
	...
	lr_think_time(think_time);
	lr_end_transaction("TC_04_select_the_option", 2);
	return 0;
}
# 8 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2

# 1 "TC_05_select_car_type.c" 1
...
{	
	...
	lr_think_time(think_time);
	lr_end_transaction("TC_05_select_car_type", 2);
	return 0;
}
# 9 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2

# 1 "TC_06_click_the_purchase_button.c" 1
TC_06_click_the_purchase_button()
{
	...
	lr_think_time(think_time);
	lr_end_transaction("TC_06_click_the_purchase_button", 2);
	return 0;
}
# 10 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2

# 1 "TC_07_enter_credit_card_information.c" 1
TC_07_enter_credit_card_information()
{
	...
	web_submit_data("purchase_quote.jsf_3", 
 	...
 	lr_think_time(think_time);
	lr_end_transaction("TC_07_enter_credit_card_information", 2);
	return 0;
}
# 11 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2
...
TC_08_logout()
{
	...
	lr_think_time(think_time);
	lr_end_transaction("TC_08_logout", 2);
	return 0;
}
# 12 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2
...
# 13 "c:\\users\\arunroshan.r\\documents\\vugen\\scripts\\borland_insurance\\borland_insurance_application\\\\combined_borland_insurance_application.c" 2
